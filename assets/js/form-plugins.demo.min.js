...
var handleDatepicker = function () {
    $("#datepicker-default").datepicker({todayHighlight: !0}), $("#datepicker-inline").datepicker({todayHighlight: !0}), $(".input-daterange").datepicker({todayHighlight: !0}), $("#datepicker-disabled-past").datepicker({todayHighlight: !0}), $("#loan-date").datepicker({todayHighlight: !0,
        autoclose: !0}), $("#datepicker-autoClose").datepicker({todayHighlight: !0, autoclose: !0
    })
    ...
    var e = {colors: [["#000000", "#424242", "#636363", "#9C9C94", "#CEC6CE", "#EFEFEF", "#EFF7F7", "#FFFFFF"]]};
    ...
    $('select[name="jquery-simplecolorpicker"]').simplecolorpicker("selectColor", "#7bd148"), $('select[name="jquery-simplecolorpicker-fa"]').simplecolorpicker({theme: "fontawesome"}), $('select[name="colorpicker-picker-longlist"]').simplecolorpicker({
        picker: !0,
        theme: "glyphicons"
    })
